...
/*
PostTenants adds a tenant

Add a new tenant and assign to the user
*/
func (a *Client) PostTenants(params *PostTenantsParams, authInfo runtime.ClientAuthInfoWriter) (*PostTenantsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	return result.(*PostTenantsOK), nil
